...
public class GoalFrame extends MyWindow implements ActionListener, SaveLoadable{
    ...
    public void saveData() {
        try(FileOutputStream fout = new FileOutputStream("Goal.dat");
    ...
    public void loadData() {
        try(FileInputStream fout = new FileInputStream("Goal.dat");
        ...
        if (e.getSource().equals(save)){
            try {
                ...
                if (value < 0){
                    ...
                    JOptionPane.showMessageDialog(null, "Please input your wanted!!", "0 Error", JOptionPane.ERROR_MESSAGE);
                }else if (value <= 0){
                    JOptionPane.showMessageDialog(null, "Price must be larger than 0!!", "0 Error", JOptionPane.ERROR_MESSAGE);
                }else{
                    saveData();
            ...
            Data.update();
            updateBar();
            JOptionPane.showMessageDialog(null, "You bought your want.","", JOptionPane.PLAIN_MESSAGE);
            name.setText("");
            money.setText("0.0");
            buy.setEnabled(false);
