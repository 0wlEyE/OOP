...
public class Data extends JInternalFrame implements ActionListener, FocusListener, SaveLoadable {
    ...
    public Data(){
        ...
        //Seperate Upper & Lower & Set Size & Visible
    ...
    public void saveData() {
        try (FileOutputStream fout = new FileOutputStream("save/Wallet.dat");
    ...
    public void loadData() {
        try (FileInputStream fout = new FileInputStream("save/Wallet.dat");
